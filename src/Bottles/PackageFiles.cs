...
namespace Bottles
{
    ...
    public class PackageFiles : IPackageFiles
    {
        ...
        public void RegisterFolder(string folderName, string directory)
        {
            ...
            {
                throw new ArgumentException("The path you have provided '{0}' contains a PathSeparator ('{1}') please do not register anything but root directories.".ToFormat(folderName, Path.PathSeparator));
            }
