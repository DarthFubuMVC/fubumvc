...
namespace FubuMVC.Core.Assets.Combination
{
    ...
    public class CombinationCandidate : ICombinationPolicy
    {
        ...
        public CombinationCandidate(string mimeType, string name)
        {
            _mimeType = mimeType;
            _name = name;
        }

        public CombinationCandidate(string mimeType, string name, IEnumerable<AssetFile> files) : this(mimeType, name)
        {
