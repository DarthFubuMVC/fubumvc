...
namespace ViewEngineIntegrationTesting.ViewEngines.Razor.Activation
{
    public class razor_views_are_activated_with_services_and_the_model_is_attached : FubuRegistryHarness
    {
