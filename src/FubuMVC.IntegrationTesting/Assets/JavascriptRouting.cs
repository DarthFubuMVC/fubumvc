        ...
        public void can_write_the_javascript_routes_for_all_methods()
        {
            using (var host = FubuApplication.DefaultPolicies().StructureMap().RunInMemory())
            {
                host.Scenario(x =>
                {
                    ...
                    x.ContentShouldContain("\"m3\":{\"name\":\"m3\",\"method\":\"POST\",\"url\":\"/js/method3\",\"params\":[]}");
                    x.ContentShouldContain("\"m4\":{\"name\":\"m4\",\"method\":\"PUT\",\"url\":\"/js/method3\",\"params\":[]}");
                    x.ContentShouldContain("\"m5\":{\"name\":\"m5\",\"method\":\"DELETE\",\"url\":\"/js/method3\",\"params\":[]}");
