...
{
    [Tag("Diagnostics")]
    public class IndexFubuDiagnostics
    {
        ...
        public IndexFubuDiagnostics(JavascriptRouteWriter routeWriter, DiagnosticJavascriptRoutes routes, IAssetFinder assets, IHttpRequest request, IFubuApplicationFiles files)
        {
