...
namespace FubuMVC.Diagnostics.Endpoints.Html
{
    public class PreviewEndpoint
    {
        ...
        public PreviewEndpoint(BehaviorGraph behaviorGraph, IServiceLocator services)
        {
            _behaviorGraph = behaviorGraph;
            _services = services;
        }

        public HtmlConventionsPreviewViewModel Get(HtmlConventionsPreviewRequestModel request)
        {
        ...
        public FubuContinuation Post(HtmlConventionsPreviewInputModel input)
        {
