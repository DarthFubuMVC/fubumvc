...
{
    [TestFixture]
    public class HttpCookieFormatterTester
    {
        [Test]
        public void one_simple_value()
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; b=2");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; b=b1=2&b2=3");
            cookie.For("a").Value.ShouldEqual("1");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=\"some text\"");
            var state = cookie.States.Single();
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; domain=http://cnn.com; max-age=5");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; Domain=http://cnn.com; path=foo;");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; Domain=http://cnn.com; path=;");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; Domain=http://cnn.com; secure;");
        ...
        {
            var cookie = HttpCookieFormatter.ToCookie("a=1; Domain=http://cnn.com; httponly;");
