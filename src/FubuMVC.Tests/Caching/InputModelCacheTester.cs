...
namespace FubuMVC.Tests.Caching
{
    ...
    public class InputModelCacheTester : InteractionContext<RequestOutputCache<TestObj>>
    {
        ...
        private Func<TestObj, RecordedOuput> recordAction;
        ...
        protected override void beforeEach()
        {
            ...
            recordAction = obj =>
            {
                ...
                return new RecordedOuput("test/html", "View:{0}".ToFormat(obj.Name));
            };
        ...
        public void should_generate_data_on_cache_miss()
        {
            ...
            var theValue = new RecordedOuput("test/html", "View:Brandon");
