...
task :unit_test => :compile do
  ...
  runner.executeTests ['FubuMVC.Tests', 'FubuCore.Testing', 'FubuLocalization.Tests', 'Bottles.Tests', 'FubuMVC.Diagnostics.Tests', 'FubuMVC.WebForms.Testing', 'FubuMVC.Spark.Tests']
end
