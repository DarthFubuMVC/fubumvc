...
task :unit_test => :compile do
  ...
  runner.executeTests ['FubuMVC.Tests', 'FubuCore.Testing', 'FubuLocalization.Tests', 'Spark.Web.FubuMVC.Tests', 'FubuValidation.Tests', 'FubuFastPack.Testing', 'FubuMVC.Validation.Tests', 'FubuMVC.Diagnostics.Tests']
end
